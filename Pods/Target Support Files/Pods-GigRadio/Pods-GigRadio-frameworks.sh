...
install_framework()
{
  local source="${BUILT_PRODUCTS_DIR}/Pods-GigRadio/$1"
...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework 'AVHexColor.framework'
  install_framework 'CLLocationManager_blocks.framework'
  install_framework 'CMDQueryStringSerialization.framework'
  install_framework 'CocoaLumberjack.framework'
  install_framework 'Functional_m.framework'
  install_framework 'HTCoreImage.framework'
  install_framework 'IFTTTLaunchImage.framework'
  install_framework 'ISO8601.framework'
  install_framework 'MTStatusBarOverlay.framework'
  install_framework 'Realm.framework'
  install_framework 'RealmSwift.framework'
  install_framework 'SVProgressHUD.framework'
  install_framework 'SimpleMotionEffects.framework'
  install_framework 'SwiftyJSON.framework'
  install_framework 'UIActionSheet_Blocks.framework'
  install_framework 'UIImage_RTTint.framework'
  install_framework 'YLMoment.framework'
fi
